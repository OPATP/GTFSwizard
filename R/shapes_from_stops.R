shapes_from_stops <- function(gtfs){
  ...
  warning('This algorithm reconstructs the shape files using a Euclidean approximation, based on the coordinates and sequence of stops for each trip.')
